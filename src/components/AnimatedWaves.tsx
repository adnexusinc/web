...
export const AnimatedWaves: React.FC<AnimatedWavesProps> = ({ className = "" }) => {
  return (
    <div className={`absolute inset-0 pointer-events-none overflow-hidden ${className}`}>
      ...
      >
        <defs>
          {/* More solid colors with minimal gradients for better WebGL performance */}
          ...
          <linearGradient id="waveGradient2" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="100%" style={{stopColor: 'hsl(var(--accent))', stopOpacity: 0.12}} />
          </linearGradient>
          <linearGradient id="waveGradient3" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" style={{stopColor: 'hsl(var(--primary))', stopOpacity: 0.18}} />
            <stop offset="100%" style={{stopColor: 'hsl(var(--primary))', stopOpacity: 0.08}} />
          </linearGradient>
          <linearGradient id="waveGradient4" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" style={{stopColor: 'hsl(var(--muted-foreground))', stopOpacity: 0.15}} />
            <stop offset="100%" style={{stopColor: 'hsl(var(--muted-foreground))', stopOpacity: 0.06}} />
          </linearGradient>
          <linearGradient id="waveGradient5" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" style={{stopColor: 'hsl(var(--accent))', stopOpacity: 0.22}} />
