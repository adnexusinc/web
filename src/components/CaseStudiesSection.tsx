                ...
                <div className="bg-gradient-to-br from-primary/5 to-primary/10 flex items-center justify-center p-8">
                  <div className="grid grid-cols-2 gap-6 w-full max-w-sm">
                    {study.metrics.map((metric, idx) => (
                      <div key={idx} className="text-center gradient-secondary p-4 rounded-xl border border-primary/20">
                        <div className="flex items-center justify-center mb-2">
                          <metric.icon className="w-5 h-5 text-primary" />
                        </div>
                        <div className="text-2xl font-bold performance-number mb-1">{metric.value}</div>
