...
import data from '../data/features-audience-targeting.json';
import { Link } from 'react-router-dom';

export default function FeaturesAudienceTargeting() {
  return (
        ...
        <section className="pt-32 pb-20 bg-gradient-to-b from-black via-gray-900 to-black">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-violet-100 to-violet-200 bg-clip-text text-transparent">
                {data.hero.headline}
              </h1>
        ...
        <section className="py-20 bg-black">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-3xl mx-auto">{data.customer_count || 'Trusted by thousands of advertisers'}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {data.features && data.features.map((feature: any, index: number) => (
                <div key={index} className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition-all duration-300 hover:shadow-2xl hover:shadow-violet-900/20">
                  <div className="mb-4"><Sparkles className="h-10 w-10 text-violet-400" /></div>
        ...
        <section className="py-20 bg-gradient-to-b from-black via-gray-900 to-black">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg">Real brands, real performance</p>
            </div>
            {data.success_stories && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.success_stories.slice(0, 9).map((story: any, index: number) => (
                  <div key={index} className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-violet-600 transition-all duration-300">
                    <div className="text-5xl font-bold text-violet-400 mb-2">{story.metric}</div>
