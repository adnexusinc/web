import { CaseStudyData } from '@/agency/types/caseStudy';
...
const bellabeat: CaseStudyData = {
  ...
  overview: [
    ...
    "Adnexus was engaged to serve as an outsourced Chief Marketing Officer (CMO) and Chief Technology Officer (CTO), helping Bellabeat enhance their market position and technical infrastructure."
  ],
  challenge: [
  ...
  solution: [
    "Adnexus implemented advanced AI algorithms to analyze consumer behavior and preferences, enabling Bellabeat to tailor its marketing campaigns effectively.",
  ...
  testimonial: {
    quote: "Adnexus transformed our approach to both marketing and technology. Their data-driven strategies helped us connect with our users on a deeper level while building the robust infrastructure we needed to scale. The results speak for themselves.",
    author: "Urška Sršen",
